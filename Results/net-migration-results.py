...
def quantify_differences(data_original, data_interpolated, header, years):
...
results = quantify_differences(data_original=odata, data_interpolated=idata, header="Net Migration Rate (per 1,000 population)", years=years_to_compare)
